...
export function getLearnToPlayGameOptions(): IGameOptions {
	...
	options.effectsAvailable[0] = [itemEffect.SpecialNoEffect, itemEffect.MoneyForSpecial, itemEffect.SpecialAdjacentMover, itemEffect.LastCardGem, itemEffect.IncreaseHandSize];
...
export function getFightAgainstBaneOptions(): IGameOptions {
	...
	options.effectsAvailable[2] = [itemEffect.DiscardItem, itemEffect.CopyOfPreviousCardToHand];
